...
static char UIControl_Block_Key;
...
- (void)handleControlEvent:(UIControlEvents)event withBlock:(void (^)(id sender))block {
    ...
    NSMutableDictionary *opreations = (NSMutableDictionary*)objc_getAssociatedObject(self, &UIControl_Block_Key);
    if(opreations == nil)
    {
        opreations = [[NSMutableDictionary alloc] init];
        objc_setAssociatedObject(self, &UIControl_Block_Key, opreations, OBJC_ASSOCIATION_RETAIN);
    }
